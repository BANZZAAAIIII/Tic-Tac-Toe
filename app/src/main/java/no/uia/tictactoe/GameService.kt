...
object GameService {
    ...
    fun createGame(player: String, state: State, callback: GameServiceCallback) {
        ...
        postRequest(data, getEndpoint(APICall.CREATE_GAME)!!, callback)
    }
    ...
    fun updateGame(player: List<String>, gameId: String, state: State, callback: GameServiceCallback) {
        ...
        postRequest(data, getEndpoint(APICall.UPDATE_GAME, gameId)!!, callback)
    }
    ...
    fun joinGame(player: String, gameId: String, callback: GameServiceCallback) {
        ...
        postRequest(data, getEndpoint(APICall.JOIN_GAME, gameId)!!, callback)
    }

    fun pollGame(gameId: String, callback: GameServiceCallback) {
        val request = object : JsonObjectRequest(Method.GET, getEndpoint(APICall.POLL_GAME, gameId)!!, null,
    ...
    private fun postRequest(data: JSONObject, url: String, callback: GameServiceCallback) {
        Log.v(LOG_TAG, "Payload: $data")

        val request = object : JsonObjectRequest(Method.POST, url, data,
            Response.Listener { response ->
                Log.v(LOG_TAG, "Response from server: $response")
